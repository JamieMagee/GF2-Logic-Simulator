...
error::error(scanner* scanner_mod)  /* the constructor */
{
	...
	errorlist.push_back("Error 0x0009: Clock must have intiger clock number greater than 0"); //9
	...
	errorlist.push_back("Error 0x000D: connection must start with the name of a device or end of device list must be terminated with END (not semicolon)"); //13
