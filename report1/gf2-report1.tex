...
% TODO: warning or error for multiple outputs to the same input?
...
% TODO: Fatal or non-fatal syntax errors? Is the point of error handling to recover from errors and still be able to run as much of the circuit as possible, or to detect and report as many of the errors present in the definition file as possible?
% Looking at the handout (particularly section 8.2), my feeling is that as much error recovery as possible should be attempted
% Maybe ask a demonstrator on Tuesday?
